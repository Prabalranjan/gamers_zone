...
<body>
  ...
  $sql = "INSERT INTO `gamers_zone`.`check_out` (`name`, `age`, `gender`, `email`, `phone`, `address`, `date`) VALUES ('$name', '$age', '$gender', '$email', '$phone', '$address', current_timestamp());";
      ...
      <form  action="payscript.php" method="post" style="padding: 25px;">
        ...
        <div class="row" >
          <div class="col-25">
            ...
            <input type="text" id="email" name="email" placeholder="Prabal@example.com">
            ...
            <!-- mobile to phone -->
            <input type="text" id="city" name="phone" placeholder="Mobile Number">
