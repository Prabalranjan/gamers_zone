...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>gamers zone | Landing, Ecommerce &amp; Business Templatee</title>
    ...
    <meta name="theme-color" content="#e0cccc">
  ...
  <body>
    ...
    <main class="main" id="top">
      <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3 d-block" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand d-inline-flex" href="index.html"><img class="d-inline-block" src="assets/img/gallery/logo.png" alt="logo" /><span class="text-1000 fs-0 fw-bold ms-2">Gamers zone</span></a>
          <button class="navbar-toggler collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">

              <!-- ###################NAVIGATION BAR##################### -->
              <li class="nav-item px-2"><a class="nav-link fw-medium active" aria-current="page" href="#best_deal">Games</a></li>
              <li class="nav-item px-2"><a class="nav-link fw-medium" href="#new_arival">Console</a></li>
              <li class="nav-item px-2"><a class="nav-link fw-medium" href="#shop_by_category">PC</a></li>
              <li class="nav-item px-2"><a class="nav-link fw-medium" href="#shop_by_category">Game Pass</a></li>
            </ul>
      ...
      <section class="py-11 bg-light-gradient border-bottom border-white border-5">
        ...
        <!-- ##########LIGHT COLOR BACKGROUND IMAGE####################### -->
        <div class="bg-holder  overlay-light" style="background-image:url(assets/img/gallery/index\ bg\ 1.jpg);background-size:cover;">
        </div>
        <!--/.bg-holder-->
          ...
          <div class="row flex-center">
            <div class="col-12 mb-10">
              <div class="d-flex align-items-center flex-column">
                ...
                <h1 class="fw-normal"> in a single click, get everything</h1>
                <h1 class="fs-4 fs-lg-8 fs-md-6 fw-bold">Hot pick games only for you...</h1>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          <div class="row g-0">
            <div class="col-md-6">
              ...
              <!-- ################## console and pc separation image ##################### -->
              <div class="card card-span h-100 text-white"> <img class="img-fluid" src="assets/img/gallery/ps5 purple.jpg" width="790" alt="..." />
                <div class="card-img-overlay d-flex flex-center"> <a class="btn btn-lg btn-light" href="#shop_by_category">For Console</a></div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="card card-span h-100 text-white"> <img class="img-fluid" src="assets/img/gallery/PC cpu.jpg" width="790" alt="..." />
                <div class="card-img-overlay d-flex flex-center"> <a class="btn btn-lg btn-light" href="#shop_by_category">For PC </a></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <!-- ============================================-->
      <!-- <section> begin ============================-->
      <section class="py-0" id="best_deal">
              ...
              <div class="carousel slide" id="carouselBestDeals" data-bs-touch="false" data-bs-interval="false">
                <div class="carousel-inner">
                  <div class="carousel-item active" data-bs-interval="10000">
                    <div class="row h-100 align-items-center g-2">
                      <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                        <div class="card card-span h-100 text-white"><img class="img-fluid h-1000" src="assets/img/gallery/CODWW2-resize.jpg" alt="..." href="product desc.php" />
                          <div class="card-img-overlay ps-0"> </div>
                          <div class="card-body ps-0 bg-200">
                            <h5 class="fw-bold text-1000 text-truncate">Call Of Duty World War II</h5>
                            <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹4000</span><span class="text-primary">₹3500</span></div>
                          </div><a class="stretched-link" href="product desc.php"></a>
                        </div>
                      </div>
                      <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                        <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/arkham city-resize.jpg" alt="..." href="product desc.php"href="product desc.php"/>
                          <div class="card-img-overlay ps-0"> </div>
                          <div class="card-body ps-0 bg-200">
                            <h5 class="fw-bold text-1000 text-truncate">Batman: Arkham Knight</h5>
                            <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹2000</span><span class="text-primary">₹1198</span></div>
                          </div><a class="stretched-link" href="product desc.php"></a>
                        </div>
                      </div>
                      <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                        <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/avengers-resize.jpg" alt="..." />
                          <div class="card-img-overlay ps-0"> </div>
                          <div class="card-body ps-0 bg-200">
                            <h5 class="fw-bold text-1000 text-truncate">Marvel's Avengers</h5>
                            <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹3000</span><span class="text-primary">₹1998</span></div>
                          </div><a class="stretched-link" href="product desc.php"></a>
                        </div>
                      </div> 
                      <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                        <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/dark soul-resize.jpg" alt="..." href="product desc.php"href="product desc.php"/>
                          <div class="card-img-overlay ps-0"> </div>
                          <div class="card-body ps-0 bg-200">
                            <h5 class="fw-bold text-1000 text-truncate">Dark Souls</h5>
                            <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹3707</span><span class="text-primary">₹3000</span></div>
                          </div><a class="stretched-link" href="product desc.php"></a>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="carousel-item" data-bs-interval="5000">
                    <div class="row h-100 align-items-center g-2">
                      <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                        <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/COJ-resize.jpg" alt="..." href="product desc.php"/>
                          <div class="card-img-overlay ps-0"> </div>
                          <div class="card-body ps-0 bg-200">
                            <h5 class="fw-bold text-1000 text-truncate">Call of Juarez: Gunslinger</h5>
                            <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹500</span><span class="text-primary">₹290</span></div>
                          </div><a class="stretched-link" href="product desc.php"></a>
                        </div>
                      </div>
                      <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                        <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/ninja blade-resize.jpg" alt="..." href="product desc.php"/>
                          <div class="card-img-overlay ps-0"> </div>
                          <div class="card-body ps-0 bg-200">
                            <h5 class="fw-bold text-1000 text-truncate">Ninja Blade</h5>
                            <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹200</span><span class="text-primary">FREE</span></div>
                          </div><a class="stretched-link" href="product desc.php"></a>
                        </div>
                      </div>
                      <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                        <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/crysis-resize.jpg" alt="..." href="product desc.php"/>
                          <div class="card-img-overlay ps-0"> </div>
                          <div class="card-body ps-0 bg-200">
                            <h5 class="fw-bold text-1000 text-truncate">Crysis</h5>
                            <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹500</span><span class="text-primary">FREE</span></div>
                          </div><a class="stretched-link" href="product desc.php"></a>
                        </div>
                      </div>
                      <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                        <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/bloodborne-rezise.jpg" alt="..." href="product desc.php"href="product desc.php"/>
                          <div class="card-img-overlay ps-0"> </div>
                          <div class="card-body ps-0 bg-200">
                            <h5 class="fw-bold text-1000 text-truncate">Bloodborne</h5>
                            <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹989</span><span class="text-primary">₹850</span></div>
                          </div><a class="stretched-link" href="product desc.php"></a>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="carousel-item" data-bs-interval="3000">
                    <div class="row h-100 align-items-center g-2">
                      <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                        <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/far cry piramal-resize.jpg" alt="..." href="product desc.php"href="product desc.php"/>
                          <div class="card-img-overlay ps-0"> </div>
                          <div class="card-body ps-0 bg-200">
                            <h5 class="fw-bold text-1000 text-truncate">Far Cry Primal</h5>
                            <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹1140</span><span class="text-primary">₹1000</span></div>
                          </div><a class="stretched-link" href="product desc.php"></a>
                        </div>
                      </div>
                      <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                        <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/splinter cells-resize.jpg" alt="..." href="product desc.php"href="product desc.php"/>
                          <div class="card-img-overlay ps-0"> </div>
                          <div class="card-body ps-0 bg-200">
                            <h5 class="fw-bold text-1000 text-truncate">Tom Clancy's Splinter Cell</h5>
                            <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹1699</span><span class="text-primary">₹1499</span></div>
                          </div><a class="stretched-link" href="product desc.php"></a>
                        </div>
                      </div>
                      <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                        <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/for honor-resize.jpg" alt="..." href="product desc.php"/>
                          <div class="card-img-overlay ps-0"> </div>
                          <div class="card-body ps-0 bg-200">
                            <h5 class="fw-bold text-1000 text-truncate">For Honort</h5>
                            <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹3000</span><span class="text-primary">₹2500</span></div>
                          </div><a class="stretched-link" href="product desc.php"></a>
                        </div>
                      </div>
                      <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                        <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/the crew-resize.jpg" alt="..." href="product desc.php"/>
                          <div class="card-img-overlay ps-0"> </div>
                          <div class="card-body ps-0 bg-200">
                            <h5 class="fw-bold text-1000 text-truncate">The Crew</h5>
                            <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹1699</span><span class="text-primary">₹1200</span></div>
                          </div><a class="stretched-link" href="product desc.php"></a>
                        </div>
                      </div>
                    </div>
      ...
      <section>
        ...
        <!-- ##########################exclusive window and pictures.############################### -->
        <div class="container">
          <div class="row h-100 g-0">
            <div class="col-md-6">
              <div class="bg-300 p-4 h-100 d-flex flex-column justify-content-center">
                <h4 class="text-800">Exclusive collection 2021</h4>
                <h1 class="fw-semi-bold lh-sm fs-4 fs-lg-5 fs-xl-6">Be the First</h1>
                <p class="mb-5 fs-1">The best everyday option in a Super Saver range within a reasonable price. It is our responsibility to keep you on top of the leaderboard. Be great &amp; , and be dominating with us.</p>
                <div class="d-grid gap-2 d-md-block"><a class="btn btn-lg btn-dark" href="#" role="button">Explore</a></div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="card card-span h-100 text-white"><img class="card-img h-100" src="assets/img/gallery/xboxx.jpg" alt="..." />
                <div class="card-img-overlay bg-dark-gradient">
                  <div class="d-flex align-items-end justify-content-center h-100"><a class="btn btn-lg text-light fs-1" href="#shop_by_category" role="button">X-Box Series X
          ...
          <div class="row h-100 g-2 py-1">
            <div class="col-md-4">
              <div class="card card-span h-100 text-white"><img class="card-img h-100" src="assets/img/gallery/ps5white.jpg" alt="..." />
                <div class="card-img-overlay bg-dark-gradient">
                  <div class="d-flex align-items-end justify-content-center h-100"><a class="btn btn-lg text-light fs-1" href="#shop_by_category" role="button">PlayStations
                      <svg class="bi bi-arrow-right-short" xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" viewBox="0 0 16 16">
                        <path fill-rule="evenodd" d="M4 8a.5.5 0 0 1 .5-.5h5.793L8.146 5.354a.5.5 0 1 1 .708-.708l3 3a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708-.708L10.293 8.5H4.5A.5.5 0 0 1 4 8z"> </path>
                      </svg></a></div>
                </div>
            ...
            <div class="col-md-4">
              <div class="card card-span h-100 text-white"><img class="card-img h-100" src="assets/img/gallery/eapass.jpg" alt="..." />
                <div class="card-img-overlay bg-dark-gradient">
                  <div class="d-flex align-items-end justify-content-center h-100"><a class="btn btn-lg text-light fs-1" href="#shop_by_category" role="button">EA Game Pass
                      <svg class="bi bi-arrow-right-short" xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" viewBox="0 0 16 16">
                        <path fill-rule="evenodd" d="M4 8a.5.5 0 0 1 .5-.5h5.793L8.146 5.354a.5.5 0 1 1 .708-.708l3 3a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708-.708L10.293 8.5H4.5A.5.5 0 0 1 4 8z"> </path>
                      </svg></a></div>
                </div>
            ...
            <div class="col-md-4">
              <div class="card card-span h-100 text-white"><img class="card-img h-100" src="assets/img/gallery/gamepass.jpg" alt="..." />
                <div class="card-img-overlay bg-dark-gradient">
                  <div class="d-flex align-items-end justify-content-center h-100"><a class="btn btn-lg text-light fs-1" href="#shop_by_category" role="button">PlayStation Plus
                      <svg class="bi bi-arrow-right-short" xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" viewBox="0 0 16 16">
                        <path fill-rule="evenodd" d="M4 8a.5.5 0 0 1 .5-.5h5.793L8.146 5.354a.5.5 0 1 1 .708-.708l3 3a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708-.708L10.293 8.5H4.5A.5.5 0 0 1 4 8z"> </path>
                      </svg></a></div>
                </div>
      ...
      <section class="py-0" id="new_arival">
        <div class="container">
          <div class="row h-100">
              ...
              <div class="carousel slide" id="carouselNewArrivals" data-bs-ride="carousel">
                <div class="carousel-inner">
                  <div class="carousel-item active" data-bs-interval="10000">
                    <div class="row h-100 align-items-center g-2">
                      <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                        <div class="card card-span h-100 text-white"><img class="card-img h-100" src="assets/img/gallery/xboxone.jpg" alt="..." />
                          <div class="card-img-overlay bg-dark-gradient d-flex flex-column-reverse">
                            <!-- <h6 class="text-primary">$175</h6> -->
                            <!-- <p class="text-400 fs-1">Xbox One</p> -->
                            <h4 class="text-light">Xbox One</h4>
                          </div><a class="stretched-link" href="#shop_by_category"></a>
                        </div>
                      </div>
                      <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                        <div class="card card-span h-100 text-white"><img class="card-img h-100" src="assets/img/gallery/msi_rtx.jpg" alt="..." />
                          <div class="card-img-overlay bg-dark-gradient d-flex flex-column-reverse">
                            <!-- <h6 class="text-primary">$175</h6> -->
                            <!-- <p class="text-400 fs-1">Jumper set for Women</p> -->
                            <h4 class="text-light">Msi Card</h4>
                          </div><a class="stretched-link" href="#shop_by_category"></a>
                        </div>
                      </div>
                      <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                        <div class="card card-span h-100 text-white"><img class="card-img h-100" src="assets/img/gallery/ps5Controller.jpg" alt="..." />
                          <div class="card-img-overlay bg-dark-gradient d-flex flex-column-reverse">
                            <!-- <h6 class="text-primary">$175</h6> -->
                            <!-- <p class="text-400 fs-1">Jumper set for Women</p> -->
                            <h4 class="text-light">PS5 Controller</h4>
                          </div><a class="stretched-link" href="#shop_by_category"></a>
                        </div>
                      </div>
                      <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                        <div class="card card-span h-100 text-white"><img class="card-img h-100" src="assets/img/gallery/nintendo.jpg" alt="..." />
                          <div class="card-img-overlay bg-dark-gradient d-flex flex-column-reverse">
                            <!-- <h6 class="text-primary">$175</h6> -->
                            <!-- <p class="text-400 fs-1">Jumper set for Women</p> -->
                            <h4 class="text-light">Nintendo</h4>
                          </div><a class="stretched-link" href="#shop_by_category"></a>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="carousel-item" data-bs-interval="5000">
                    <div class="row h-100 align-items-center g-2">
                      <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                        <div class="card card-span h-100 text-white"><img class="card-img h-100" src="assets/img/gallery/ps5_controller_skin3.jpg" alt="..." />
                          <div class="card-img-overlay bg-dark-gradient d-flex flex-column-reverse">
                            <!-- <h6 class="text-primary">$175</h6> -->
                            <!-- <p class="text-400 fs-1">Jumper set for Women</p> -->
                            <h4 class="text-light">Carbon Series</h4>
                          </div><a class="stretched-link" href="#"></a>
                        </div>
                      </div>
                      <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                        <div class="card card-span h-100 text-white"><img class="card-img h-100" src="assets/img/gallery/nintendoprocontrollerfront.jpg" alt="..." />
                          <div class="card-img-overlay bg-dark-gradient d-flex flex-column-reverse">
                            <!-- <h6 class="text-primary">$175</h6> -->
                            <!-- <p class="text-400 fs-1">Jumper set for Women</p> -->
                            <h4 class="text-light">Marble Series</h4>
                          </div><a class="stretched-link" href="#"></a>
                        </div>
                      </div>
                      <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                        <div class="card card-span h-100 text-white"><img class="card-img h-100" src="assets/img/gallery/ps5_controller_skin1.jpg" alt="..." />
                          <div class="card-img-overlay bg-dark-gradient d-flex flex-column-reverse">
                            <!-- <h6 class="text-primary">$175</h6> -->
                            <!-- <p class="text-400 fs-1">Jumper set for Women</p> -->
                            <h4 class="text-light">Retro Series</h4>
                          </div><a class="stretched-link" href="#shop_by_category"></a>
                        </div>
                      </div>
                      <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                        <div class="card card-span h-100 text-white"><img class="card-img h-100" src="assets/img/gallery/ps5_controller_skin2.jpg" alt="..." />
                          <div class="card-img-overlay bg-dark-gradient d-flex flex-column-reverse">
                            <!-- <h6 class="text-primary">$175</h6> -->
                            <!-- <p class="text-400 fs-1">Jumper set for Women</p> -->
                            <h4 class="text-light">Camouflage Series</h4>
                          </div><a class="stretched-link" href="#shop_by_category"></a>
                        </div>
                      </div>
                    </div>
            ...
            <div class="col-12">
              <nav>
                <div class="nav nav-tabs majestic-tabs mb-4 justify-content-center" id="nav-tab" role="tablist">
                  <button class="nav-link active" id="nav-women-tab" data-bs-toggle="tab" data-bs-target="#nav-women" type="button" role="tab" aria-controls="nav-women" aria-selected="true">For Pc</button>
                  <button class="nav-link" id="nav-men-tab" data-bs-toggle="tab" data-bs-target="#nav-men" type="button" role="tab" aria-controls="nav-men" aria-selected="false">For Console</button>
                </div>
                <div class="tab-content" id="nav-tabContent">
                  <div class="tab-pane fade show active" id="nav-women" role="tabpanel" aria-labelledby="nav-women-tab">
                    <ul class="nav nav-pills justify-content-center mb-5" id="pills-tab-women" role="tablist">
                      <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="pills-wtshirt-tab" data-bs-toggle="pill" data-bs-target="#pills-wtshirt" type="button" role="tab" aria-controls="pills-wtshirt" aria-selected="true">Games</button>
                      </li>
                      <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pills-dresses-tab" data-bs-toggle="pill" data-bs-target="#pills-dresses" type="button" role="tab" aria-controls="pills-dresses" aria-selected="false">keyboard</button>
                      </li>
                      <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pills-wshoes-tab" data-bs-toggle="pill" data-bs-target="#pills-wshoes" type="button" role="tab" aria-controls="pills-wshoes" aria-selected="false">Mouse</button>
                      </li>
                      <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pills-wwatch-tab" data-bs-toggle="pill" data-bs-target="#pills-wwatch" type="button" role="tab" aria-controls="pills-wwatch" aria-selected="false">Gpu</button>
                      </li>
                      <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pills-wsunglasses-tab" data-bs-toggle="pill" data-bs-target="#pills-wsunglasses" type="button" role="tab" aria-controls="pills-wsunglasses" aria-selected="false">Cabinets </button>
                      </li>
                      <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pills-wbagpacks-tab" data-bs-toggle="pill" data-bs-target="#pills-wbagpacks" type="button" role="tab" aria-controls="pills-wbagpacks" aria-selected="false">Passes </button>
                      </li>
                    </ul>
                        ...
                        <div class="carousel slide" id="carouselCategoryDresses" data-bs-touch="false" data-bs-interval="false">
                          <div class="carousel-inner">
                            <div class="carousel-item active" data-bs-interval="10000">
                              <div class="row h-100 align-items-center g-2">
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/keyboard 1.jpg" alt="..."href="keyboard desc.php""/>
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">Logitech keyboard</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹2000</span><span class="text-primary">₹1700</span></div>
                                    </div><a class="stretched-link" href="keyboard desc.php"></a>
                                  </div>
                                </div>
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/keyboard 2.jpg" alt="..."href="keyboard desc.php""/>
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">Logitech keyboard 2</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹2000</span><span class="text-primary">₹1700</span></div>
                                    </div><a class="stretched-link" href="keyboard desc.php"></a>
                                  </div>
                                </div>
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/keyboard 3.jpg" alt="..."href="keyboard desc.php""/>
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">Red Gear keyboard</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹1700</span><span class="text-primary">₹1300</span></div>
                                    </div><a class="stretched-link" href="keyboard desc.php"></a>
                                  </div>
                                </div>
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/keyboard 4.jpg" alt="..." href="keyboard desc.php"/>
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">EVO fox keyboard</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹3700</span><span class="text-primary">₹2700</span></div>
                                    </div><a class="stretched-link" href="keyboard desc.php"></a>
                                  </div>
                                </div>
                              </div>
                        ...
                        <div class="carousel slide" id="carouselCategoryWTshirt" data-bs-touch="false" data-bs-interval="false">
                          <div class="carousel-inner">
                            <div class="carousel-item active" data-bs-interval="10000">
                              <div class="row h-100 align-items-center g-2">
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/far cry piramal-resize.jpg" alt="..." href="product desc.php"/>
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">far cry piramal</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹1200</span><span class="text-primary">₹1200</span></div>
                                    </div><a class="stretched-link" href="product desc.php"></a>
                                  </div>
                                </div>
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/for honor-resize.jpg" alt="..." href="product desc.php"/>
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">For honor</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹2500</span><span class="text-primary">₹2000</span></div>
                                    </div><a class="stretched-link" href="product desc.php"></a>
                                  </div>
                                </div>
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/the crew-resize.jpg" alt="..." href="product desc.php"/>
                                    ...
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">The Crew</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹1200</span><span class="text-primary">₹770</span></div>
                                    </div><a class="stretched-link" href="product desc.php"></a>
                                  </div>
                                </div>
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/splinter cells-resize.jpg" alt="..." href="product desc.php"/>
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">Splinter cell</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹2200</span><span class="text-primary">₹1500</span></div>
                                    </div><a class="stretched-link" href="product desc.php"></a>
                                  </div>
                                </div>
                              </div>
                            ...
                            <!-- ##################################### end of this is t-shirt section ############################### -->
                        ...
                        <div class="carousel slide" id="carouselCategoryWShoes" data-bs-touch="false" data-bs-interval="false">
                          <div class="carousel-inner">
                            <div class="carousel-item active" data-bs-interval="10000">
                              <div class="row h-100 align-items-center g-2">
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/mouse 1.jpg" alt="..." href="mouse desc.php"/>
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">Logitech white mouse</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹1200</span><span class="text-primary">₹1000</span></div>
                                    </div><a class="stretched-link" href="mouse desc.php"></a>
                                  </div>
                                </div>
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/mouse 2.jpg" alt="..." href="mouse desc.php"/>
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">Logitech black mouse</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹1200</span><span class="text-primary">₹1000</span></div>
                                    </div><a class="stretched-link" href="mouse desc.php"></a>
                                  </div>
                                </div>
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/mouse 3.jpg" alt="..." href="mouse desc.php"/>
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">Zebronics</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹1200</span><span class="text-primary">₹1000</span></div>
                                    </div><a class="stretched-link" href="mouse desc.php"></a>
                                  </div>
                                </div>
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/mouse 4.jpg" alt="..." href="mouse desc.php"/>
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">Lenovo Legion</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹1200</span><span class="text-primary">₹1000</span></div>
                                    </div><a class="stretched-link" href="mouse desc.php"></a>
                                  </div>
                                </div>
                        ...
                        <div class="carousel slide" id="carouselCategoryWwatch" data-bs-touch="false" data-bs-interval="false">
                          <div class="carousel-inner">
                            <div class="carousel-item active" data-bs-interval="10000">
                              <div class="row h-100 align-items-center g-2">
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/rtx1.jpg" alt="..." />
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">Gigabyte RTX 3060</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹50000</span><span class="text-primary">₹50000</span></div>
                                    </div><a class="stretched-link" href="#"></a>
                                  </div>
                                </div>
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/rtx2.jpg" alt="..." />
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">RTX 3060 TI ASUS</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹59000</span><span class="text-primary">₹50000</span></div>
                                    </div><a class="stretched-link" href="#"></a>
                                  </div>
                                </div>
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/rtx3.jpg" alt="..." />
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">RTX 2060 </h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹50000</span><span class="text-primary">₹30000</span></div>
                                    </div><a class="stretched-link" href="#"></a>
                                  </div>
                                </div>
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/rtx4.jpg" alt="..." />
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">Gigabyte</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹29000</span><span class="text-primary">₹20000</span></div>
                                    </div><a class="stretched-link" href="#"></a>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div class="row h-100 align-items-center g-2">
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/watch-1.png" alt="..." />
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">Watch naruto</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">$500</span><span class="text-primary">$275</span></div>
                                    </div><a class="stretched-link" href="#"></a>
                                  </div>
                                </div>
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/watch-2.png" alt="..." />
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">Watch sasuke</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">$500</span><span class="text-primary">$275</span></div>
                                    </div><a class="stretched-link" href="#"></a>
                                  </div>
                                </div>
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/watch-3.png" alt="..." />
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">Watch itachi</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">$500</span><span class="text-primary">$275</span></div>
                                    </div><a class="stretched-link" href="#"></a>
                                  </div>
                                </div>
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/watch-4.png" alt="..." />
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">Watch prabal</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">$500</span><span class="text-primary">$275</span></div>
                                    </div><a class="stretched-link" href="#"></a>
                                  </div>
                                </div>
                        ...
                        <div class="carousel slide" id="carouselCategoryWSunglasses" data-bs-touch="false" data-bs-interval="false">
                          <div class="carousel-inner">
                            <div class="carousel-item active" data-bs-interval="10000">
                              <div class="row h-100 align-items-center g-2">
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/cabinet 1.jpg" alt="..." />
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">Zebronics</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹35000</span><span class="text-primary">₹25000</span></div>
                                    </div><a class="stretched-link" href="#"></a>
                                  </div>
                                </div>
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/cabinet 2.jpg" alt="..." />
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">Cronus</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹30000</span><span class="text-primary">₹20000</span></div>
                                    </div><a class="stretched-link" href="#"></a>
                                  </div>
                                </div>
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/cabinet 3.jpg" alt="..." />
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">ANT Esports</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹35000</span><span class="text-primary">₹35000</span></div>
                                    </div><a class="stretched-link" href="#"></a>
                                  </div>
                                </div>
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/cabinet 4.jpg" alt="..." />
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">Deep cool cabinet</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹10000</span><span class="text-primary">₹5000</span></div>
                                    </div><a class="stretched-link" href="#"></a>
                                  </div>
                                </div>
                              </div>
                        ...
                        <div class="carousel slide" id="carouselCategoryWBagpacks" data-bs-touch="false" data-bs-interval="false">
                          <div class="carousel-inner">
                            <div class="carousel-item active" data-bs-interval="10000">
                              <div class="row h-100 align-items-center g-2">
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/steam1.jpg" alt="..." />
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">Steam Card</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹1000</span><span class="text-primary">₹900</span></div>
                                    </div><a class="stretched-link" href="#"></a>
                                  </div>
                                </div>
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/steam2.jpg" alt="..." />
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">Steam Card</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹1000</span><span class="text-primary">₹900</span></div>
                                ...
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/steam3.jpg" alt="..." />
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">Steam Card</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹1000</span><span class="text-primary">₹900</span></div>
                                ...
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/steam4.jpg" alt="..." />
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">Steam Card</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹1000</span><span class="text-primary">₹900</span></div>
                  ...
                  <div class="tab-pane fade" id="nav-men" role="tabpanel" aria-labelledby="nav-men-tab">
                    <ul class="nav nav-pills mb-5 justify-content-center" id="pills-tab-men" role="tablist">
                      <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="pills-tshirt-tab" data-bs-toggle="pill" data-bs-target="#pills-tshirt" type="button" role="tab" aria-controls="pills-tshirt" aria-selected="true">Games</button>
                      </li>
                      <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pills-shirt-tab" data-bs-toggle="pill" data-bs-target="#pills-shirt" type="button" role="tab" aria-controls="pills-shirt" aria-selected="false">Controller</button>
                      </li>
                      <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pills-shoes-tab" data-bs-toggle="pill" data-bs-target="#pills-shoes" type="button" role="tab" aria-controls="pills-shoes" aria-selected="false">Headphones</button>
                      </li>
                      <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pills-watch-tab" data-bs-toggle="pill" data-bs-target="#pills-watch" type="button" role="tab" aria-controls="pills-watch" aria-selected="false">Stand </button>
                      </li>
                      <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pills-sunglasses-tab" data-bs-toggle="pill" data-bs-target="#pills-sunglasses" type="button" role="tab" aria-controls="pills-sunglasses" aria-selected="false">Skins </button>
                      </li>
                      <li class="nav-item" role="presentation">
                        <button class="nav-link" id="console_passes" data-bs-toggle="pill" data-bs-target="#pills-bagpacks" type="button" role="tab" aria-controls="pills-bagpacks" aria-selected="false">Passes </button>
                      </li>
                    </ul>
                            ...
                            <div class="carousel-item active" data-bs-interval="10000">
                              <div class="row h-100 align-items-center g-2">
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  ...
                                  <!-- ##################################### start of t-shirt section ############################### -->


                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/GOW4.jpg" alt="..." href="product desc.php"/>
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">Game 1</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹3000</span><span class="text-primary">₹2300</span></div>
                                    </div><a class="stretched-link" href="product desc.php"></a>
                                  </div>
                                </div>
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/ac valhalla ps.jpg" alt="..." href="product desc.php"/>
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">Game 2</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹3000</span><span class="text-primary">₹2300</span></div>
                                    </div><a class="stretched-link" href="product desc.php"></a>
                                  </div>
                                </div>
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/spiderman MM.jpg" alt="..." href="product desc.php"/>
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">Game 3</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹3000</span><span class="text-primary">₹2300</span></div>
                                    </div><a class="stretched-link" href="product desc.php"></a>
                                  </div>
                                </div>
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/far cry6.jpg" alt="..." href="product desc.php"/>
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">Game 4</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹3000</span><span class="text-primary">₹2300</span></div>
                                    </div><a class="stretched-link" href="product desc.php"></a>
                                  </div>
                                </div>
                        ...
                        <div class="carousel slide" id="carouselCategoryShirt" data-bs-touch="false" data-bs-interval="false">
                          <div class="carousel-inner">
                            <div class="carousel-item active" data-bs-interval="10000">
                              <div class="row h-100 align-items-center g-2">
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/ps5_controller_skin1.jpg" alt="..." href="controller desc.html"/>
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">Controller 1</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹2000</span><span class="text-primary">₹1500</span></div>
                                    </div><a class="stretched-link" href="controller desc.html"></a>
                                  </div>
                                </div>
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/ps5_controller_skin2.jpg" alt="..." href="controller desc.html"/>
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">Controller 2</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹2000</span><span class="text-primary">₹1500</span></div>
                                    </div><a class="stretched-link" href="controller desc.html"></a>
                                  </div>
                                </div>
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/nintendoprocontrollerfront.jpg" alt="..." href="controller desc.html"/>
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">Controller 3</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹2000</span><span class="text-primary">₹1500</span></div>
                                    </div><a class="stretched-link" href="controller desc.html"></a>
                                  </div>
                                </div>
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/ps5_controller_skin3.jpg" alt="..." href="controller desc.html"/>
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">Controller 4</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹₹1500</span><span class="text-primary">₹1500</span></div>
                                    </div><a class="stretched-link" href="controller desc.html"></a>
                                  </div>
                                </div>
                              </div>
                        ...
                        <div class="carousel slide" id="carouselCategoryShoes" data-bs-touch="false" data-bs-interval="false">
                          <div class="carousel-inner">
                            <div class="carousel-item active" data-bs-interval="10000">
                              <div class="row h-100 align-items-center g-2">
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/headphones1.jpg" alt="..." />
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">Headphones 1</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹9000</span><span class="text-primary">₹7000</span></div>
                                    </div><a class="stretched-link" href="#"></a>
                                  </div>
                                </div>
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/headphones2.jpg" alt="..." />
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">Headphones 2</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹9000</span><span class="text-primary">₹7000</span></div>
                                    </div><a class="stretched-link" href="#"></a>
                                  </div>
                                </div>
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/headphones3.jpg" alt="..." />
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">Headphones 3</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹9000</span><span class="text-primary">₹7000</span></div>
                                    </div><a class="stretched-link" href="#"></a>
                                  </div>
                                </div>
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/headphones4.jpg" alt="..." />
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">Headphones 4</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹9000</span><span class="text-primary">₹7000</span></div>
                                    </div><a class="stretched-link" href="#"></a>
                                  </div>
                                </div>
                        ...
                        <div class="carousel slide" id="carouselCategoryWatch" data-bs-touch="false" data-bs-interval="false">
                          <div class="carousel-inner">
                            <div class="carousel-item active" data-bs-interval="10000">
                              <div class="row h-100 align-items-center g-2">
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/stand1.jpg" alt="..." />
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">Stand 1</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹2000</span><span class="text-primary">₹1000</span></div>
                                    </div><a class="stretched-link" href="#"></a>
                                  </div>
                                </div>
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/stand2.jpg" alt="..." />
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">Stand 2</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹2000</span><span class="text-primary">₹1000</span></div>
                                    </div><a class="stretched-link" href="#"></a>
                                  </div>
                                </div>
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/stand3.jpg" alt="..." />
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">Stand 3</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹2000</span><span class="text-primary">₹1000</span></div>
                                    </div><a class="stretched-link" href="#"></a>
                                  </div>
                                </div>
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/stand4.jpg" alt="..." />
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">Stand 4</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹2000</span><span class="text-primary">₹1000</span></div>
                                    </div><a class="stretched-link" href="#"></a>
                                  </div>
                                </div>
                        ...
                        <div class="carousel slide" id="carouselCategorySunglasses" data-bs-touch="false" data-bs-interval="false">
                          <div class="carousel-inner">
                            <div class="carousel-item active" data-bs-interval="10000">
                              <div class="row h-100 align-items-center g-2">
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/skin1.jpg" alt="..." />
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">Skin 1</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹5000</span><span class="text-primary">₹2750</span></div>
                                    </div><a class="stretched-link" href="#"></a>
                                  </div>
                                </div>
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/skin2.jpg" alt="..." />
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">Skin 2</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹5000</span><span class="text-primary">₹2750</span></div>
                                    </div><a class="stretched-link" href="#"></a>
                                  </div>
                                </div>
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/skin3.jpg" alt="..." />
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">Skin 3</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹5000</span><span class="text-primary">₹2750</span></div>
                                    </div><a class="stretched-link" href="#"></a>
                                  </div>
                                </div>
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/skin4.jpg" alt="..." />
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">Skin 4</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹5000</span><span class="text-primary">₹2750</span></div>
                                    </div><a class="stretched-link" href="#"></a>
                                  </div>
                                </div>
                        ...
                        <div class="carousel slide" id="carouselCategoryBagpacks" data-bs-touch="false" data-bs-interval="false">
                          <div class="carousel-inner">
                            <div class="carousel-item active" data-bs-interval="10000">
                              <div class="row h-100 align-items-center g-2">
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/gamepass1.jpg" alt="..." />
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">Game Pass 1</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹500</span><span class="text-primary">₹275</span></div>
                                    </div><a class="stretched-link" href="#"></a>
                                  </div>
                                </div>
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/gamepass2.jpg" alt="..." />
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">Game Pass 2</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹500</span><span class="text-primary">₹275</span></div>
                                    </div><a class="stretched-link" href="#"></a>
                                  </div>
                                </div>
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/gamepass3.jpg" alt="..." />
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">Game Pass 3</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹2000</span><span class="text-primary">₹1275</span></div>
                                    </div><a class="stretched-link" href="#"></a>
                                  </div>
                                </div>
                                <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                  <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/gamepass4.jpg" alt="..." />
                                    <div class="card-img-overlay ps-0"> </div>
                                    <div class="card-body ps-0 bg-200">
                                      <h5 class="fw-bold text-1000 text-truncate">Game Pass 4</h5>
                                      <div class="fw-bold"><span class="text-600 me-2 text-decoration-line-through">₹500</span><span class="text-primary">₹275</span></div>
                                    </div><a class="stretched-link" href="#"></a>
                                  </div>
                                </div>
      ...
      <section class="py-0" id="outlet">
        ...
        <div class="container">
          <div class="row h-100 g-0">
            <div class="col-md-6">
              <div class="card card-span h-100 text-white"><img class="card-img h-100" src="assets/img/gallery/ac logo.jpg  " alt="..." />
            ...
            <div class="col-md-6 h-100">
              <div class="row h-100 g-0">
                <div class="col-md-6 h-100">
                  <div class="card card-span h-100 text-white"><img class="card-img h-100" src="assets/img/gallery/mk logo.jpg" alt="..." />
                    <div class="card-img-overlay bg-dark-gradient rounded-0">
                ...
                <div class="col-md-6">
                  <div class="card card-span h-100 text-white"><img class="card-img h-100" src="assets/img/gallery/ow logo.png" alt="..." />
                    <div class="card-img-overlay bg-dark-gradient rounded-0">
                      <div class="p-5 p-xl-5 p-md-0">
                ...
                <div class="col-md-6">
                  <div class="card card-span h-100 text-white"><img class="card-img h-100" src="assets/img/gallery/ds logo.jpg" alt="..." />
                    <div class="card-img-overlay bg-dark-gradient rounded-0">
                      <div class="p-5 p-xl-5 p-md-0">
                ...
                <div class="col-md-6">
                  <div class="card card-span h-100 text-white"><img class="card-img h-100" src="assets/img/gallery/rkstr logo.jpg" alt="..." />
                    <div class="card-img-overlay bg-dark-gradient rounded-0">
                      <div class="p-5 p-xl-5 p-md-0">
      ...
      <section>
        ...
        <div class="container">
          <div class="row h-100 g-0">
            <div class="col-md-6">
              <div class="bg-300 p-4 h-100 d-flex flex-column justify-content-center">
                <h1 class="fw-semi-bold lh-sm fs-4 fs-lg-5 fs-xl-6">New Launch Today </h1>
                <p class="mb-5 fs-1">Experience the adventure of DEATH ,sequeal of famouse game darksiders. </p>
                <div class="d-grid gap-2 d-md-block"><a class="btn btn-lg btn-dark" href="#!" role="button">BUY</a></div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="card card-span h-100 text-white"><img class="card-img h-100" src="assets/img/gallery/death pose.jpg" alt="..." /><a class="stretched-link" href="#!"></a></div>
            </div>
          </div>
        </div>
        <!-- end of .container-->
      ...
      <!--  ####################################### start of see address ############################################# -->
      <section class="py-11">
        <div class="bg-holder " style="background-image:url(assets/img/gallery/all\ in\ one\ 2.jpg);background-position: center;background-size:cover;">
        </div>
        <!--/.bg-holder-->
        ...
        <div class="container">
          <div class="row">
            <div class="col-6 col-lg-2 mb-3">
              ...
              <ul class="list-unstyled mb-md-4 mb-lg-0">
                ...
                <li class="lh-lg"><a class="text-800 text-decoration-none" href="#!">Game Blogger</a></li>
              </ul>
            </div>
            <div class="col-6 col-lg-2 mb-3">
            ...
            <div class="col-sm-6 col-lg-auto ms-auto">
              ...
              <p class="text-800">
                <svg class="feather feather-phone me-3" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                  <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path>
                </svg><span class="text-800">+918638238145</span>
              </p>
              <p class="text-800">
                ...
                </svg><span class="text-800">prabalranjangoswami@gmail.com</span>
              </p>
            </div>
          </div>
          ...
          <div class="row flex-center my-3">
            <div class="col-md-6 order-1 order-md-0">
              <p class="my-2 text-1000 text-center text-md-start"> Created By&nbsp;
                ...
                </svg>&nbsp;by&nbsp;<a class="text-800" href="https://themewagon.com/" target="_blank">THE GUY PRESENTING HIMSELF </a>
              </p>
            </div>
            <div class="col-md-6">
              <div class="text-center text-md-end"><a href="https://www.facebook.com/"><span class="me-4" data-feather="facebook"></span></a><a href="https://www.instagram.com/_blue_shinigami_/"> <span class="me-4" data-feather="instagram"></span></a><a href="#!"> <a href="https://www.youtube.com/"><span class="me-4" data-feather="youtube"></span></a></span></a><a href="#!"> <span class="me-4" data-feather="twitter"></span></a></div>
            </div>
          </div>
        </div>
        <!-- end of .container-->
