...
@media screen and (max-width: 620px) {
    ...
    <div class="header">
        <div class="row r1">
            <div class="col-md-9 abc">
                <h1>Call Of Duty World War II</h1>
            </div>
        ...
        <div class="row r3">
            <div class="col-md-5 p-0 klo">
                <ul>
                    <li>Activision</li>
                    <li>FPS shooting</li>
                    <li>campaign mode -> 34 GB</li>
                    <li>Multiplayer -> 24 GB</li>
                    <li>Easy Returns</li>
            ...
            <div class="col-md-7"> <img src="assets/img/gallery/CODWW2.jpg" width="90%" height="95%"> </div>
        </div>
    </div>
    <div class="footer d-flex flex-column mt-5">
        <div class="row r4">
            ...
            <div class="col-md-2 myt "><button type="button" class="btn btn-outline-warning"><a href="checkout.php">BUY NOW</a></button></div>
        </div>
    </div>
</div>
